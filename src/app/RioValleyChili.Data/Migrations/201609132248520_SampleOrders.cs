                ...
                c => new
                    {
                        ...
                        ShipToContact = c.String(maxLength: 60),
                        Comments = c.String(),
                        PrintNotes = c.String(),
                        ...
                        BrokerId = c.Int(),
                        SampleID = c.Int(),
                        RequestAddress_AddressLine1 = c.String(maxLength: 50),
                        RequestAddress_AddressLine2 = c.String(maxLength: 50),
                        RequestAddress_AddressLine3 = c.String(maxLength: 50),
                        RequestAddress_City = c.String(maxLength: 75),
                        RequestAddress_State = c.String(maxLength: 50),
                        RequestAddress_PostalCode = c.String(maxLength: 15),
                        RequestAddress_Country = c.String(maxLength: 50),
