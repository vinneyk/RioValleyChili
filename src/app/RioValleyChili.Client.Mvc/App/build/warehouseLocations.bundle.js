...
/***/ (function(module, exports, __webpack_require__) {
	...
	ko.components.register('warehouse-editor', __webpack_require__(218)); 
	ko.components.register('locations-editor', __webpack_require__(220)); 
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = { viewModel: EditWarehouseViewModel, template: __webpack_require__(219)};
...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"container-fluid\">\r\n    <section class=\"col-sm-6\" data-bind=\"with: facilityInfo\">\r\n        <form class=\"form-horizontal\">\r\n            <div class=\"form-group \" data-bind=\"validationElement: FacilityName\">\r\n                <label for=\"facilityname\" class=\"control-label col-md-3\">Name</label>\r\n                <div class=\"col-sm-9\">\r\n                    <input class=\"form-control\" id=\"facilityname\" Name\" data-bind=\"value: FacilityName\" />\r\n                </div>\r\n            </div>\r\n            <div class=\"form-group\">\r\n                <label class=\"control-label col-md-3\" for=\"phonenumber\">Phone</label>\r\n                <div class=\"col-sm-9\">\r\n                    <input class=\"form-control\" id=\"phonenumber\" data-bind=\"value: PhoneNumber\" />\r\n                </div>\r\n            </div>\r\n            <div class=\"form-group\">\r\n                <label class=\"control-label col-md-3\" for=\"emailaddress\">Email</label>\r\n                <div class=\"col-sm-9\">\r\n                    <input class=\"form-control col-md-9\" id=\"emailaddress\" data-bind=\"value: EmailAddress\" />\r\n                </div>\r\n            </div>\r\n            <div class=\"form-group\">\r\n                <div class=\"col-sm-offset-3 col-sm-9\">\r\n                    <div class=\"checkbox\">\r\n                        <label>\r\n                            <input type=\"checkbox\" data-bind=\"checked: Active\"> Active\r\n                        </label>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </form>\r\n            <div class=\"col-md-9 col-md-offset-3\">\r\n                <button type=\"button\" class=\"btn btn-success\" data-bind=\"click: $root.saveFacilityData\">Save</button>\r\n                <button type=\"button\" class=\"btn btn-link\" data-bind=\"click: $root.cancelFacilityEdit\">Cancel</button>\r\n            </div>\r\n    </section>\r\n    <section class=\"col-sm-6\">\r\n        <div data-bind=\"component: { name: 'address-editor', params: { input: facilityInfo.Address, output: AddressOutput }}\"></div>\r\n    </section>\r\n    <!-- ko if: !isNew() -->\r\n    <br />\r\n    <br />\r\n    <!-- Need to edit styles so that br tags are no longer needed -->\r\n    <div data-bind=\"component: { name: 'locations-editor', params: { input: facilityInfo, output: LocationsOutput, facilityInfo: facilityInfo }}\"></div>\r\n    <!-- /ko -->\r\n</div>"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var warehouseService = __webpack_require__(6),
	    WarehouseLocationFactory = __webpack_require__(221);
	...
	module.exports = { viewModel: EditLocationsViewModel, template: __webpack_require__(222) };
...
/***/ (function(module, exports) {
	...
	module.exports = "<!-- ko if: !isCreatingGroup() -->\r\n<label for=\"location-group-select\">Filter by Group: </label>\r\n<select id=\"location-group-select\" data-bind=\"options: Groups, value: selectedGroup\"></select>\r\n<i class=\"icon-button icon-button-1 fa fa-unlock-alt\" data-bind=\"click: unfreezeGroup\"></i>\r\n<i class=\"icon-button icon-button-1 fa fa-lock\" data-bind=\"click: freezeGroup\"></i>\r\n<i class=\"icon-button icon-button-1 fa fa-plus\" data-bind=\"click: createGroup\"></i>\r\n<!-- /ko -->\r\n\r\n<!-- ko if: isCreatingGroup -->\r\n<label for=\"location-group-create\">Create New Group: </label>\r\n<input type=\"text\" id=\"location-group-create\" data-bind=\"value: newGroupName\" />\r\n<i class=\"icon-button icon-button-1 fa fa-times\" data-bind=\"click: cancelCreateGroup\"></i>\r\n<!-- /ko -->\r\n\r\n\r\n<table class=\"reset table table-condensed table-striped table-hover\">\r\n    <thead>\r\n        <tr>\r\n            <th class=\"col-md-7\">Row</th>\r\n            <th class=\"col-md-3\">Status</th>\r\n            <th class=\"col-md-2\">Tools</th>\r\n        </tr>\r\n    </thead>\r\n    <tbody data-bind=\"foreach: filteredLocations\">\r\n        <tr>\r\n            <td><input placeholder=\"Row text\" data-bind=\"value: Row, enable: isEditing\"/></td>\r\n            <td>\r\n                <i class=\"icon-button icon-button-1 fa\" data-bind=\"css: statusIcon()\"></i>\r\n                <select data-bind=\"value: Status, options: Status.options, optionsText: 'value', optionsValue: 'key', visible: isEditing\"></select>\r\n            </td>\r\n            <td>\r\n                <!-- ko if: !isEditing() -->\r\n                <i class=\"icon-button icon-button-1 fa fa-pencil\" data-bind=\"click: editLocation\"></i>\r\n                <!-- /ko -->\r\n                <!-- ko if: isEditing -->\r\n                <i class=\"icon-button icon-button-1 fa fa-check\" data-bind=\"click: saveLocation\"></i>\r\n                <i class=\"icon-button icon-button-1 fa fa-undo\" data-bind=\"visible: !isNew(), click: undoEdit\"></i>\r\n                <i class=\"icon-button icon-button-1 fa fa-times\" data-bind=\"visible: isNew, click: removeNewLocation\"></i>\r\n                <!-- /ko -->\r\n            </td>\r\n        </tr>\r\n    </tbody>\r\n    <tbody>\r\n        <tr>\r\n            <td colspan=\"3\">\r\n                <a class=\"text-button\" href=\"#\" data-bind=\"click: addLocation\"><i class=\"icon-button fa fa-plus-square\"></i> Add New Location</a>\r\n            </td>\r\n        </tr>\r\n    </tbody>\r\n</table>\r\n"
