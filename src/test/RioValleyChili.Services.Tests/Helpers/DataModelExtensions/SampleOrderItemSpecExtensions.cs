...
{
    internal static class SampleOrderItemSpecExtensions
    {
        internal static void AssertEqual(this SampleOrderItemSpec expected, ISampleOrderItemSpecReturn result)
        {
            if(expected == null)
            {
